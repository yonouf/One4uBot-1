...
@register(outgoing=True, pattern="^.xnotes$")
...
@register(outgoing=True, pattern=r"^.xclear (\w*)")
...
@register(outgoing=True, pattern=r"^.xsave (\w*)")
...
@register(outgoing=True, pattern="^.xrmbotnotes (.*)")
